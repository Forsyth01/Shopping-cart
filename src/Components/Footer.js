...
const Footer = () => {
    return (
        ...
        <div className='bg-gray-900 text-white dark:bg-gray-900'>
            <div class=" font-bold m-auto w-[80%]">
                ...
                <div class="py-6 px-4 bg-gray-900 dark:bg-gray-700 md:flex md:items-center md:justify-between m-auto w-[80%]">
                    <span class="text-sm sm:text-center">© 2022 <a href="https://flowbite.com/">Forsyth okoeguale™</a>. All Rights Reserved.
                    </span>
